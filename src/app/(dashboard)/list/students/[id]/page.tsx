        ...
        <div className="flex flex-col lg:flex-row gap-4">
          ...
          <div className="bg-blueSky py-6 px-4 rounded-md  flex-1 flex gap-4">
            ...
            <div className="w-2/3 flex flex-col justify-between gap-4">
              <div className="flex items-center gap-4">
                <h1 className="text-xl font-semibold">Ida McKenzie</h1>
              </div>
          ...
          <div className="flex-1 flex gap-4 justify-between flex-wrap">
            ...
            <div className="bg-white p-4 rounded-md flex gap-4 w-full md:w-[48%] xl:w-[48%] 2xl:w-[45%]">
              ...
              />
              <div className="">
                <h1 className="text-lg font-semibold">92%</h1>
            ...
            <div className="bg-white p-4 rounded-md flex gap-4 w-full md:w-[48%] xl:w-[45%] 2xl:w-[45%]">
              ...
              />
              <div className="">
                <h1 className="text-lg font-semibold">Freshman</h1>
            ...
            <div className="bg-white p-4 rounded-md flex gap-4 w-full md:w-[48%] xl:w-[45%] 2xl:w-[45%]">
              ...
              />
              <div className="">
                <h1 className="text-lg font-semibold">Computer Science</h1>
      ...
      <div className="w-full xl:w-1/3 flex flex-col gap-4">
        <div className="bg-white p-4 rounded-md">
          ...
          <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-500">
            <Link className="p-3 rounded-md bg-blueSky" href={"/"}>Student's Lessons</Link>
            <Link className="p-3 rounded-md bg-blueSkyLight" href={"/"}>Student's Teacher</Link>
            <Link className="p-3 rounded-md bg-gray-100" href={"/"}>Student's Results</Link>
